                                ...
                                <div class="jumbotron pb-0 mb-0" style="background-color: #e9ecef00">
                                    ...
                                    <div class="row m-0 pb-4">
                                        ...
                                        <div class="col-lg-3 mb-2 mb-lg-0">
                                                <div class="row m-0 align-items-center">
                                                <div class="col-0 p-0" style="margin-right: 14px;">
                                                    <dx:ASPxLabel ID="ASPxLabel5" runat="server" Font-Size="12px" Text="št. Dobavnice : " Font-Bold="true"></dx:ASPxLabel>
                                                </div>
                                                <div class="col p-0">
                                        ...
                                        <div class="col-lg-3 mb-2 mb-lg-0">
                                            <div class="row m-0 align-items-center justify-content-center">
                                                <div class="col-0 p-0" style="margin-right: 15px;">
                                                    <dx:ASPxLabel ID="ASPxLabel6" runat="server" Font-Size="12px" Text="DATUM DOBAVNICE : " Font-Bold="true"></dx:ASPxLabel>
                                                </div>
                                                <div class="col p-0">
                                        ...
                                        <div class="col-lg-3 mb-2 mb-lg-0">
                                            <div class="row m-0 align-items-center justify-content-center">
                                                <div class="col-0 p-0" style="margin-right: 15px;">
                                                    <dx:ASPxLabel ID="ASPxLabel8" runat="server" Font-Size="12px" Text="DATUM PREJETJA : " Font-Bold="true"></dx:ASPxLabel>
                                                </div>
                                                <div class="col p-0">
                                                    <dx:ASPxDateEdit ID="DateEditDeliveryRecivedMaterialDate" runat="server" EditFormat="Date" Width="100%"
                                                        CssClass="text-box-input date-edit-padding" Font-Size="13px"
                                                        ClientInstanceName="dateEditDeliveryRecivedMaterialDate" ClientEnabled="false" BackColor="LightGray" Font-Bold="true">
                                                        <FocusedStyle CssClass="focus-text-box-input" />
                                                        <CalendarProperties TodayButtonText="Danes" ClearButtonText="Izbriši" />
                                                        <DropDownButton Visible="true"></DropDownButton>
                                                        <ClientSideEvents Init="SetFocus" />
