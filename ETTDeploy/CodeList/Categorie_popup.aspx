<%@ Page Title="Kategorija" Language="C#" MasterPageFile="~/MasterPages/Popup.Master" AutoEventWireup="true" CodeBehind="Categorie_popup.aspx.cs" Inherits="ETT_Web.CodeList.Categorie_popup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row m-0 d-flex align-items-center pb-2">
        ...
        <div class="col no-padding-left">
            <dx:ASPxTextBox runat="server" ID="txtCode" ClientInstanceName="clientTxtCode"
